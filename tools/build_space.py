...
<div class="wrap">
  ...
  Same model, same voice, same text &mdash; the only difference is the front-end.</p>

  <p class="links">
    <a href="https://github.com/GhanaNLP/poto-tts">GitHub</a> &middot;
    <a href="https://pypi.org/project/poto-tts/"><code>pip install poto-tts</code></a> &middot;
    <a href="https://huggingface.co/ghananlpcommunity/poto-tts-kokoro-gh">the voice</a> &middot;
    <a href="https://github.com/GhanaNLP/poto-tts/blob/main/docs/MOBILE.md">Android &amp; iOS</a>
  </p>
...
{items}
  ...
  <footer>
    Kokoro v1.0 through sherpa-onnx, eight British speakers. Pronunciation comes from
    44,321 Ghanaian words compiled into espeak's own dictionary &mdash; data rather than
    code, so Android, iOS and WebAssembly give the same result. The Kokoro column is
    standard Kokoro: its own package, weights and misaki grapheme-to-phoneme.
    <br><br>
    ...
    &middot;
    <a href="https://github.com/GhanaNLP/ghana-english-g2p">the lexicon</a> &middot;
    <code>pip install poto-tts</code>
  </footer>
</div>
</body>
</html>
